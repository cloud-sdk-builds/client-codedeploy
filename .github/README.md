...
[`@aws-sdk/client-codedeploy`](https://www.npmjs.com/package/@aws-sdk/client-codedeploy/v/3.1126.0).
...
- @aws-sdk/client-codedeploy v3.1126.0 - [https://cloud-sdk-builds.github.io/?sdk=client-codedeploy&version=3.1126.0](https://cloud-sdk-builds.github.io/?sdk=client-codedeploy&version=3.1126.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codedeploy@3.1126.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KkXGucjbaajpm7sl8NOJFpPA+zPHFfhxx+2/fQqFHhDbLGUZCc7cMSXdrx620HE0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-codedeploy": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codedeploy@3.1126.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codedeploy@3.1126.0/index.min.mjs": "sha384-KkXGucjbaajpm7sl8NOJFpPA+zPHFfhxx+2/fQqFHhDbLGUZCc7cMSXdrx620HE0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-codedeploy/blob/refs/tags/3.1126.0/LICENSE
```
