...
[`@aws-sdk/client-codedeploy`](https://www.npmjs.com/package/@aws-sdk/client-codedeploy/v/3.1059.0).
...
- @aws-sdk/client-codedeploy v3.1059.0 - [https://cloud-sdk-builds.github.io/?sdk=client-codedeploy&version=3.1059.0](https://cloud-sdk-builds.github.io/?sdk=client-codedeploy&version=3.1059.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codedeploy@3.1059.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KJstLIimIPFniNgXbYLXgwtVPznIygFzE16tGCQL4jygINo6saPt5YGhLXQsbqwh
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codedeploy/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-codedeploy": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codedeploy@3.1059.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codedeploy@3.1059.0/index.min.mjs": "sha384-KJstLIimIPFniNgXbYLXgwtVPznIygFzE16tGCQL4jygINo6saPt5YGhLXQsbqwh"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-codedeploy";
...
```
https://github.com/cloud-sdk-builds/client-codedeploy/blob/refs/tags/3.1059.0/LICENSE
```
