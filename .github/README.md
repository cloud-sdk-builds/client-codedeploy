...
[`@aws-sdk/client-codedeploy`](https://www.npmjs.com/package/@aws-sdk/client-codedeploy/v/3.552.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codedeploy@3.552.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-s0pLrTQHz9EvynftxaFMpeKkSREIJUedVoXhR8BGf5TL8usmMOUCYQeq80Xgal2/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-codedeploy": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codedeploy@3.552.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codedeploy@3.552.0/index.min.mjs": "sha384-s0pLrTQHz9EvynftxaFMpeKkSREIJUedVoXhR8BGf5TL8usmMOUCYQeq80Xgal2/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-codedeploy/blob/refs/tags/3.552.0/LICENSE
```
