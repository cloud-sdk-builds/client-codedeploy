...
[`@aws-sdk/client-codedeploy`](https://www.npmjs.com/package/@aws-sdk/client-codedeploy/v/3.810.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codedeploy@3.810.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qICF0l+y3q15PPaIK+dQwRD6tSq38mXqy6a18G0m3IOJad8UIdbR2CQ4swQL9JLO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-codedeploy": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codedeploy@3.810.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codedeploy@3.810.0/index.min.mjs": "sha384-qICF0l+y3q15PPaIK+dQwRD6tSq38mXqy6a18G0m3IOJad8UIdbR2CQ4swQL9JLO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-codedeploy/blob/refs/tags/3.810.0/LICENSE
```
