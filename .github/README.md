...
[`@aws-sdk/client-codedeploy`](https://www.npmjs.com/package/@aws-sdk/client-codedeploy/v/3.932.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codedeploy@3.932.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UN5ThJfMIBc/XgGkfOgfKpsFmMQyse2mTG/vs+t41ueTWJbLKdCouMRSTNe+ZIMC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-codedeploy": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codedeploy@3.932.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codedeploy@3.932.0/index.min.mjs": "sha384-UN5ThJfMIBc/XgGkfOgfKpsFmMQyse2mTG/vs+t41ueTWJbLKdCouMRSTNe+ZIMC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-codedeploy/blob/refs/tags/3.932.0/LICENSE
```
